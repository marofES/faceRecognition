...
student_images_folder = "path/to/student/images"
...
# Initialize the list of IP cameras (replace with your camera URLs)
camera_urls = ["http://your_ip_camera1", "http://your_ip_camera2"]
video_captures = [cv2.VideoCapture(url) for url in camera_urls]

while True:
    frames = []

    # Capture frames from multiple IP cameras
